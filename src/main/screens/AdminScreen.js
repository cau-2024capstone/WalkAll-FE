...
const AdminScreen = () => {
  ...
  useEffect(() => {
    fetch("https://accurately-healthy-duckling.ngrok-free.app/admin/inquiries")
  ...
  const handleApprove = (inquiryIdf) => {
    ...
    // 승인 API 호출
    fetch(
      `https://accurately-healthy-duckling.ngrok-free.app/admin/inquiries/${inquiryIdf}/approve`,
      {
        method: "GET",
      }
    ).catch((error) => {
  ...
  const handleReject = (inquiryIdf) => {
    ...
    // 거절 API 호출
    fetch(
      `https://accurately-healthy-duckling.ngrok-free.app/admin/inquiries/${inquiryIdf}/reject`,
      {
        method: "GET",
      }
    ).catch((error) => {
