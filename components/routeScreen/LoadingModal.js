    ...
    const fetchData = async () => {
      try {
        ...
        const getClosestPointId = async (lat, lng, pointType) => {
          const url = `${API_BASE_URL}/api/points/closest-point?lat=${lat}&lng=${lng}&radius=50`;
        ...
        const fetchRoutes = async (bodyParams) => {
          ...
          if (startId === endId) {
            ...
            const url = `${API_BASE_URL}/api/routes/findRoutesWithSameStartPoint`;
